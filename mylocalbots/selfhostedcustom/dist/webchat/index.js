...
var _c3poLogo = _interopRequireDefault(require("../assets/c3po-logo.png"));
var _introImage = _interopRequireDefault(require("../assets/intro-image.jpg"));
var _launcherLogo = _interopRequireDefault(require("../assets/launcher-logo.png"));
...
const webchat = exports.webchat = {
  theme: {
    ...
    brand: {
      // color: 'blue',
      image: _r2d2Logo.default
    },
    triggerButton: {
      image: _launcherLogo.default,
      style: {
        width: '200px'
      }
    ...
    message: {
      bot: {
        image: _c3poLogo.default,
        // set it to 'null' to hide this image
        style: {
          border: 'none',
          color: 'black',
          borderRadius: '20px',
      ...
      customTypes: [_calendarMessage.default]
    },
    button: {
      style: {
        color: 'black',
    ...
    scrollbar: {
      ...
      thumb: {
        opacity: 1,
        // color: 'yellow',
        bgcolor: 'linear-gradient(-131deg,rgba(231, 176, 43) 0%,rgb(193, 62, 81) 100%);',
        border: '20px'
      }
      // track: {
      //   color: 'black',
